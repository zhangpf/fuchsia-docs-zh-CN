...
[*英文原文快照*](https://github.com/fuchsia-mirror/zircon/blob/5d84b450c16bf6ac8ef3b77a4b8b0b4bddd22fd6/docs/fidl/index.md)
...
*   [FIDL示例][FIDL Examples]：用于开发使用的一些示例代码片段
*   [FIDL教程（英文原文）][FIDL Tutorial]：关于在多种语言中使用FIDL服务的教程

[FIDL: Wire Format Specification]: wire-format/index.md
[FIDL: Language Specification]: language.md
[FIDL: Compiler Specification]: compiler.md
[FIDL: C Language Bindings]: https://github.com/fuchsia-mirror/docs/blob/master/development/languages/fidl/c.md
[FIDL: C++ Language Bindings]: https://github.com/fuchsia-mirror/docs/blob/master/development/languages/fidl/cpp.md
[FIDL Examples]: https://github.com/fuchsia-mirror/zircon/tree/master/system/host/fidl/examples
[FIDL Tutorial]: https://github.com/fuchsia-mirror/docs/blob/master/development/languages/fidl/tutorial.md
...
- [编译器](https://github.com/fuchsia-mirror/zircon/tree/master/system/ulib/fidl)
- [C绑定](https://github.com/fuchsia-mirror/zircon/tree/master/system/ulib/fidl)
...
[FIDL：有线格式的文档][FIDL: Wire Format Specification]
